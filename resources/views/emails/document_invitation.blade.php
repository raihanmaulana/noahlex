...
<body>
    <div class="email-container">
        ...
        <div class="content">
            <p>Hello,</p>
            <p><strong>{{ $inviterName }}</strong> has invited you to collaborate on the document:</p>
            <h3 style="color: #1d72b8; margin-top: 10px;">{{ $documentName }}</h3>
            <p>Please click the button below to login and view the document:</p>
            <p style="text-align: center;">
                <a href="{{ url('/login') }}" class="btn">View Document</a>
            </p>
